...
image: /images/posts/httparchive-mcp/preview.png
---
...
<figure style="text-align: center; margin: 2rem 0;">
  <img src="/images/posts/httparchive-mcp/preview.png" alt="HTTP Archive Tech Report MCP in action — asking GitHub Copilot about CMS performance" style="max-width: 70%; margin: 0 auto;" />
</figure>
...
The MCP server is open source. If there's a dimension you want exposed that isn't there yet — a new metric, a filter, a different aggregation — the handler may be extended: [HTTPArchive/tech-report-apis](https://github.com/HTTPArchive/tech-report-apis/blob/main/apps/report-api/mcpHandler.js).
