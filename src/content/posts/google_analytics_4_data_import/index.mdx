...
<figure style="text-align: center; margin: 2rem 0;">
  <img src="/images/projects/google_analytics_4_data_import/diagram_ga4_data_import.png" alt="Google Analytics 4 Data Import diagram" style="max-width: 85%; margin: 0 auto;" />
</figure>
...
<figure style="text-align: center; margin: 2rem 0;">
  <img src="/images/posts/google_analytics_4_data_import/scheduled_queries.png" alt="Scheduled queries" style="max-width: 75%; margin: 0 auto;" />
</figure>
...
<figure style="text-align: center; margin: 2rem 0;">
  <img src="/images/posts/google_analytics_4_data_import/gcp_workflow.png" alt="GCP Workflow" style="max-width: 75%; margin: 0 auto;" />
</figure>
...
<NotebookEmbed path="src/content/posts/google_analytics_4_data_import/notebook.ipynb" cell="create_instance" echo={true} />
...
<NotebookEmbed path="src/content/posts/google_analytics_4_data_import/notebook.ipynb" cell="mount_bucket" echo={true} />
...
<NotebookEmbed path="src/content/posts/google_analytics_4_data_import/notebook.ipynb" cell="bg_to_gcs" echo={true} />
...
<figure style="text-align: center; margin: 2rem 0;">
  <img src="/images/posts/google_analytics_4_data_import/ga4_data_source.png" alt="GA4 Data Source" style="max-width: 70%; margin: 0 auto;" />
</figure>

<NotebookEmbed path="src/content/posts/google_analytics_4_data_import/notebook.ipynb" cell="configure_data_source" echo={true} />
...
<figure style="text-align: center; margin: 2rem 0;">
  <img src="/images/posts/google_analytics_4_data_import/public_key_on_vm_instance.png" alt="Public key on VM instance" style="max-width: 70%; margin: 0 auto;" />
</figure>

<NotebookEmbed path="src/content/posts/google_analytics_4_data_import/notebook.ipynb" cell="add_server_pub_key" echo={true} />
