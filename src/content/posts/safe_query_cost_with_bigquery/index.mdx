...
date: "2024-06-20"
categories: ["bigquery"]
image: /images/posts/safe_query_cost_with_bigquery/big_query.png
---
...
<figure style="text-align: center; margin: 2rem 0;">
  <img src="/images/posts/safe_query_cost_with_bigquery/big_query.png" alt="Big query protection in action" style="max-width: 70%; margin: 0 auto;" />
</figure>
...
<figure style="text-align: center; margin: 2rem 0;">
  <img src="/images/posts/safe_query_cost_with_bigquery/query_quotas.png" alt="BigQuery API / Quotas" style="max-width: 70%; margin: 0 auto;" />
</figure>
...
<figure style="text-align: center; margin: 2rem 0;">
  <img src="/images/posts/safe_query_cost_with_bigquery/usage_log_chart.png" alt="Log Analytics / BigQuery Analytics Usage" style="max-width: 70%; margin: 0 auto;" />
</figure>
