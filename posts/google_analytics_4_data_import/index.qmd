...
![Google Analytics 4 Data Import diagram](./images/diagram_ga4_data_import.png){.preview-image}
...
[Open in Google Colab](https://colab.research.google.com/github/max-ostapenko/ga4_data_import/blob/main/scripts/GA4_Data_Import.ipynb) and get your pipeline now.

![Configuration notebook](./images/configuration_notebook.png)
